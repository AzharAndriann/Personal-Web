...
export function Project() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A landing page designed to make it easier for customers to view menus and place delivery orders at fast food stores.",
    ...
    },
    {
      ...
      type: "Academic Project",
      description:
        "An interactive website for calculating and visually displaying graphs of sine functions.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Here are some of the projects I have worked on, ranging from landing
            pages to management systems.
          </p>
        </motion.div>
                ...
                <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-4">
                      <Dialog>
                        <DialogTrigger
                          className="flex w-full bg-white hover:bg-white/60 text-primary rounded-md"
                          asChild
                        >
                          <Button
                            size="sm"
                            className="flex w-full bg-white text-primary hover:bg-white/60"
                          >
